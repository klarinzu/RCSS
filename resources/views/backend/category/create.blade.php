                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card card-light">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <textarea class="form-control description-textarea" name="body" id="" value="{{ old('body') }}" cols="30" rows="5">{{ old('excerpt') }}</textarea>
                                    @error('excerpt')
                            ...
                            <div class="card card-primary sticky-bottom">
                                ...
                                <div class="card-body pb-0">
                                    ...
                                    <div class="form-group pt-0 pb-0 text-right">
                                        <!-- <button type="submit" class="btn btn-primary">Publish Category
                                        </button> -->
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body pt-0 pb-0">
                                    ...
                                    <div class="form-group text-center">
                                        <button type="submit" class="btn btn-success">Publish Category</button>
                                    </div>
                                </div>
                            </div>
                        </div>
