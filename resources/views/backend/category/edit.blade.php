                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="card card-light">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    <textarea class="form-control description-textarea" name="body" id="" value="{{ old('body') }}" cols="30" rows="5">{{ old('body', $category->body) }}</textarea>
                                    @error('body')
                            ...
                            <div class="card card-primary">
                                ...
                                <div class="card-body pt-0 pb-0">
                                    ...
                                    <div class="form-group text-center">
                                        <button onclick="return confirm('Are you sure you want to update this item?');" type="submit" class="btn btn-danger">Update Category</button>
                                    </div>
                                </div>
                            </div>
                        </div>
