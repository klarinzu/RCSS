                ...
                <div class="col-md-4">
                    <div class="sticky-top">
                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <select required="required" name="status" id="inputStatus" class="form-control custom-select">
                                        ...
                                        <option value="1" {{ isset($service->status) && $service->status == 1 ? 'selected' : '' }}>PUBLISHED</option>
                                        <option value="0" {{ isset($service->status) && $service->status == 0 ? 'selected' : '' }}>DRAFT</option>
                                    </select>
                                </div>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body pt-0 pb-0">
                                <div class="form-group">
                                    <small class="text-red">&nbsp;&nbsp;Note: size: Width-1200px Height: 800px</small>
                                    <input name="image" accept="image/*" type="file" id="imgInp">
                                    @if ($service->image)
                                        <img class="img-fluid" style="width: 150px; margin-top:10px; border:1px solid black;" id="blah" src="{{ asset('uploads/images/service/' . $service->image) }}" alt="your image">
                                @else
                                        <img style="width: 150px; margin-top:10px; border:1px solid black;" id="blah" src="{{ asset('uploads/images/no-image.jpg') }}" alt="your image">
                                @endif
                                </div>
    ...
    <script>
        $(document).ready(function() {
            $('#updateBtn').click(function(e) {
                ...
                button.html(spinner.prop('outerHTML') + ' Updating...');
