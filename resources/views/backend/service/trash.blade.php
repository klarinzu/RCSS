                                            ...
                                            <tr>
                                                ...
                                                <td class="project-actions text-center">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <a class="btn btn-info btn-sm restore-btn"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to restore <span id="restoreServiceTitle"></span>?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <a href="#" class="btn btn-info" id="confirmRestore">Restore</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Are you sure you want to permanently delete <span id="deleteServiceTitle"></span>?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
...
@section('js')
    ...
    {{-- Restore and Delete Modal Scripts --}}
    <script>
        $(document).ready(function() {
            ...
            $('.restore-btn').click(function(e) {
                ...
                $('#restoreServiceTitle').text(serviceTitle);
                $('#confirmRestore').attr('href', restoreUrl);
            ...
            $('.delete-btn').click(function() {
                ...
                $('#deleteServiceTitle').text(serviceTitle);
