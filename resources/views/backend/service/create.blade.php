                            ...
                            <div class="card-body pb-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <select required="required" name="status" id="inputStatus" class="form-control custom-select">
                                        ...
                                        <option class="published" value="1" selected>PUBLISHED</option>
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body pt-0 pb-0">
                                <div class="form-group">
                                    ...
                                    <img style="width: 175px; margin-top:10px; border:1px solid black;" id="blah" src="{{ asset('uploads/images/no-image.jpg') }}" alt="your image">
                                </div>
